...
/* Adapated from numpy/core/include/numpy/npy_math.h */
 ...
 */
DL_EXPORT(double) npy_sin(double x);
DL_EXPORT(double) npy_cos(double x);
DL_EXPORT(double) npy_tan(double x);
DL_EXPORT(double) npy_sinh(double x);
DL_EXPORT(double) npy_cosh(double x);
DL_EXPORT(double) npy_tanh(double x);

DL_EXPORT(double) npy_asin(double x);
DL_EXPORT(double) npy_acos(double x);
DL_EXPORT(double) npy_atan(double x);
DL_EXPORT(double) npy_aexp(double x);
DL_EXPORT(double) npy_alog(double x);
DL_EXPORT(double) npy_asqrt(double x);
DL_EXPORT(double) npy_afabs(double x);

DL_EXPORT(double) npy_log(double x);
DL_EXPORT(double) npy_log10(double x);
DL_EXPORT(double) npy_exp(double x);
DL_EXPORT(double) npy_sqrt(double x);

DL_EXPORT(double) npy_fabs(double x);
DL_EXPORT(double) npy_ceil(double x);
DL_EXPORT(double) npy_fmod(double x, double y);
DL_EXPORT(double) npy_floor(double x);
...
DL_EXPORT(double) npy_atan2(double x, double y);
DL_EXPORT(double) npy_pow(double x, double y);
DL_EXPORT(double) npy_modf(double x, double* y);

DL_EXPORT(double) npy_copysign(double x, double y);
DL_EXPORT(double) npy_nextafter(double x, double y);
DL_EXPORT(double) npy_spacing(double x);
...
DL_EXPORT(float) npy_sinf(float x);
DL_EXPORT(float) npy_cosf(float x);
DL_EXPORT(float) npy_tanf(float x);
DL_EXPORT(float) npy_sinhf(float x);
DL_EXPORT(float) npy_coshf(float x);
DL_EXPORT(float) npy_tanhf(float x);
DL_EXPORT(float) npy_fabsf(float x);
DL_EXPORT(float) npy_floorf(float x);
DL_EXPORT(float) npy_ceilf(float x);
DL_EXPORT(float) npy_rintf(float x);
DL_EXPORT(float) npy_truncf(float x);
DL_EXPORT(float) npy_sqrtf(float x);
DL_EXPORT(float) npy_log10f(float x);
DL_EXPORT(float) npy_logf(float x);
DL_EXPORT(float) npy_expf(float x);
DL_EXPORT(float) npy_expm1f(float x);
DL_EXPORT(float) npy_asinf(float x);
DL_EXPORT(float) npy_acosf(float x);
DL_EXPORT(float) npy_atanf(float x);
DL_EXPORT(float) npy_asinhf(float x);
DL_EXPORT(float) npy_acoshf(float x);
DL_EXPORT(float) npy_atanhf(float x);
DL_EXPORT(float) npy_log1pf(float x);
DL_EXPORT(float) npy_exp2f(float x);
DL_EXPORT(float) npy_log2f(float x);

DL_EXPORT(float) npy_atan2f(float x, float y);
DL_EXPORT(float) npy_hypotf(float x, float y);
DL_EXPORT(float) npy_powf(float x, float y);
DL_EXPORT(float) npy_fmodf(float x, float y);

DL_EXPORT(float) npy_modff(float x, float* y);

DL_EXPORT(float) npy_copysignf(float x, float y);
DL_EXPORT(float) npy_nextafterf(float x, float y);
DL_EXPORT(float) npy_spacingf(float x);
...
DL_EXPORT(npy_longdouble) npy_modfl(npy_longdouble x, npy_longdouble* y);

DL_EXPORT(npy_longdouble) npy_copysignl(npy_longdouble x, npy_longdouble y);
DL_EXPORT(npy_longdouble) npy_nextafterl(npy_longdouble x, npy_longdouble y);
DL_EXPORT(npy_longdouble) npy_spacingl(npy_longdouble x);

/*
 * Non standard functions
 */
DL_EXPORT(double) npy_deg2rad(double x);
DL_EXPORT(double) npy_rad2deg(double x);
DL_EXPORT(double) npy_logaddexp(double x, double y);
DL_EXPORT(double) npy_logaddexp2(double x, double y);

DL_EXPORT(float) npy_deg2radf(float x);
DL_EXPORT(float) npy_rad2degf(float x);
DL_EXPORT(float) npy_logaddexpf(float x, float y);
DL_EXPORT(float) npy_logaddexp2f(float x, float y);
 ...
 */
DL_EXPORT(double) npy_cabs(npy_cdouble z);
DL_EXPORT(double) npy_carg(npy_cdouble z);
 ...
 */
DL_EXPORT(float) npy_cabsf(npy_cfloat z);
DL_EXPORT(float) npy_cargf(npy_cfloat z);
